...
<div class="box-content">
	<h2><i class="fa fa-id-card-o"></i> Listar Serviços</h2>
	...
	<table>
		...
		?>
			<tr>
				...
				<td><a actionBtn="delete" class="btn delete" href="<?php echo INCLUDE_PATH_PAINEL ?>listar-servico?excluir=<?php echo $value['id']; ?>"><i class="fa fa-times"></i> Excluir</a></td>
				<td><a class="btn order" href="<?php echo INCLUDE_PATH_PAINEL ?>listar-servico?order=up&id=<?php echo $value['id'] ?>"><i class="fa fa-angle-up"></i></a></td>
				<td><a class="btn order" href="<?php echo INCLUDE_PATH_PAINEL ?>listar-servico?order=down&id=<?php echo $value['id'] ?>"><i class="fa fa-angle-down"></i></a></td>
			</tr>
		<?php }?>
